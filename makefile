OBJS	= Alarm.o Camera.o CompositeRoom.o Doors.o Lights.o main.o SmartThermostatIntegrator.o Thermostat.o
SOURCE	= Alarm.cpp Camera.cpp CompositeRoom.cpp Doors.cpp Lights.cpp main.cpp SmartThermostatIntegrator.cpp Thermostat.cpp
